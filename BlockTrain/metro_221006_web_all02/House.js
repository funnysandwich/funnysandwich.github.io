function House(begin, W, D, H, floor_num, index_z, index_block) {
  ...
  this.have_billboardSide = false;
  if (open_billboardSide  &&  random(1)<rate_billboardSide  &&  this.floor_num>1) {
    if (index_z == 0) {
      this.have_billboardSide = true;
    } else if (index_z == 1) {
      this.have_billboardSide = true;
    } else if (index_z == 5) {
      this.have_billboardSide = false;
    } else if (random(1)<map(index_z, 2, 6, rate_billboardSide*0.7, 0.01)) {
      this.have_billboardSide = true;
    }
  }
  ...
  if (this.have_billboard) {
    ...
    for (let i=0; i<this.num_billboard; i++) {
      ...
      this.W_billboard[i] = min(max(this.H_billboard[i] * 3, real(100)), this.W*0.95);
  ...
  if (this.have_billboardRoof) {
    this.state_billboardRoof = floor(random(0.5, 2));
  ...
  if (this.have_billboardSide) {
    this.state_billboardSide = floor(random(0.5, 2));
    this.which_billboardSide = floor(random(0, 4));
    this.index_bottom_floor_billboardSide = min(floor(random(0, 4)), this.floor_num-2);
    this.Y_fromBottomFloor_billboardSide = random(this.H_ori*0.1, this.H_ori*0.9);
    if (this.floor_num == 2) {
      this.Y_fromBottomFloor_billboardSide = random(this.H_ori*0.5, this.H_ori*0.7);
    }

    this.W_billboardSide = real(random(35, 60));
    this.H_billboardSide = min(this.W_billboardSide * 3, (this.H_ori*this.floor_num)*0.9);
    if (this.floor_num == 2) {
      this.H_billboardSide = min(this.H_billboardSide, this.H_ori*1.15);
    }
    this.H_billboardSide = min(this.H_billboardSide, (this.floor_num-this.index_bottom_floor_billboardSide)*this.H_ori - this.Y_fromBottomFloor_billboardSide);
    this.W_billboardSide = this.H_billboardSide / 3.0;

    if (num_PB2 > 0) {
      this.which_BILL_side = floor(random(1, num_PB2+1));
    } else {
      this.which_BILL_side = 0;
    }



    this.node_billboardSide = new Array(4);
    for (let i=0; i<this.node_billboardSide.length; i++) {
      let h = floor(i/2) * this.H_billboardSide;
      this.node_billboardSide[i] = p5.Vector.sub(this.node[this.index_bottom_floor_billboardSide+1], this.node[this.index_bottom_floor_billboardSide]).setMag(this.Y_fromBottomFloor_billboardSide+h);
      if (i == 0  ||  i == 3) {
        this.node_billboardSide[i].add(p5.Vector.sub(this.node_wall[this.index_bottom_floor_billboardSide][3], this.node_wall[this.index_bottom_floor_billboardSide][2]).setMag(this.W_billboardSide/2.0));
      } else {
        this.node_billboardSide[i].add(p5.Vector.sub(this.node_wall[this.index_bottom_floor_billboardSide][3], this.node_wall[this.index_bottom_floor_billboardSide][2]).setMag(-this.W_billboardSide/2.0));
      }
      if (this.which_billboardSide == 0) {
        this.node_billboardSide[i].add(this.node_wall[this.index_bottom_floor_billboardSide][0]).add(-real(40), 0, 0);
      } else if (this.which_billboardSide == 1) {
        this.node_billboardSide[i].add(this.node_wall[this.index_bottom_floor_billboardSide][1]).add(real(40), 0, 0);
      } else if (this.which_billboardSide == 2) {
        this.node_billboardSide[i].add(this.node_wall[this.index_bottom_floor_billboardSide][2]).add(real(40), 0, 0);
      } else if (this.which_billboardSide == 3) {
        this.node_billboardSide[i].add(this.node_wall[this.index_bottom_floor_billboardSide][3]).add(-real(40), 0, 0);
      }
    }
  }
  ...
  this.display = function() {
    ...
    if (this.have_billboardSide) {
      if (this.state_billboardSide == 1) {
        noStroke();
        fill(255);
        beginShape();
        texture(BILL[2][this.which_BILL_side]);
        vertex(this.node_billboardSide[3].x, this.node_billboardSide[3].y, this.node_billboardSide[3].z, 0, 0);
        vertex(this.node_billboardSide[2].x, this.node_billboardSide[2].y, this.node_billboardSide[2].z, 1, 0);
        vertex(this.node_billboardSide[1].x, this.node_billboardSide[1].y, this.node_billboardSide[1].z, 1, 1);
        vertex(this.node_billboardSide[0].x, this.node_billboardSide[0].y, this.node_billboardSide[0].z, 0, 1);
        endShape(CLOSE);
        fill(255);
      }
    }
  ...
  this.display_TRIANGLES = function() {
    ...
    if (this.have_billboardSide) {
      t = constrain(map(this.node_billboardSide[0].z, skyline.z, 0, 1, 0), 0, 1);
      fill(lerpColor(c_near, c_far, t));
      TRIANGLES_getLine_weightToL(this.node_billboardSide[0], this.node_billboardSide[3], real(4));
      TRIANGLES_getLine_weightToR(this.node_billboardSide[1], this.node_billboardSide[2], real(4));
      TRIANGLES_getLine_weightToD_Y(this.node_billboardSide[0].copy().add(-real(4), 0, 0), this.node_billboardSide[1].copy().add(real(4), 0, 0), real(4));
      TRIANGLES_getLine_weightToU_Y(this.node_billboardSide[3].copy().add(-real(4), 0, 0), this.node_billboardSide[2].copy().add(real(4), 0, 0), real(4));

      if (this.state_billboardSide == 0) {
        //[0][1]在下面
        TRIANGLES_getLine_weight_T(this.node_billboardSide[0], this.node_billboardSide[2], real(4));
      }

      if (this.which_billboardSide == 0  ||  this.which_billboardSide == 3) {
        TRIANGLES_getLine_weight_Y(p5.Vector.sub(this.node_billboardSide[2], this.node_billboardSide[1]).mult(0.15).add(this.node_billboardSide[1]), 
          p5.Vector.sub(this.node_billboardSide[2], this.node_billboardSide[1]).mult(0.15).add(this.node_billboardSide[1]).add(real(70), 0, 0), real(4)
          );
        TRIANGLES_getLine_weight_Y(p5.Vector.sub(this.node_billboardSide[1], this.node_billboardSide[2]).mult(0.15).add(this.node_billboardSide[2]), 
          p5.Vector.sub(this.node_billboardSide[1], this.node_billboardSide[2]).mult(0.15).add(this.node_billboardSide[2]).add(real(70), 0, 0), real(4)
          );
      } else {
        TRIANGLES_getLine_weight_Y(p5.Vector.sub(this.node_billboardSide[3], this.node_billboardSide[0]).mult(0.15).add(this.node_billboardSide[0]), 
          p5.Vector.sub(this.node_billboardSide[3], this.node_billboardSide[0]).mult(0.15).add(this.node_billboardSide[0]).add(-real(70), 0, 0), real(4)
          );
        TRIANGLES_getLine_weight_Y(p5.Vector.sub(this.node_billboardSide[0], this.node_billboardSide[3]).mult(0.15).add(this.node_billboardSide[3]), 
          p5.Vector.sub(this.node_billboardSide[0], this.node_billboardSide[3]).mult(0.15).add(this.node_billboardSide[3]).add(-real(70), 0, 0), real(4)
          );
      }
    }
  ...
  this.displayInfo = function() {
    ...
    if (this.have_billboardSide) {
      ...
      LINES_getLine(this.node_billboardSide[0], this.node_billboardSide[1]);
      LINES_getLine(this.node_billboardSide[1], this.node_billboardSide[2]);
      LINES_getLine(this.node_billboardSide[2], this.node_billboardSide[3]);
      LINES_getLine(this.node_billboardSide[3], this.node_billboardSide[0]);
    }
