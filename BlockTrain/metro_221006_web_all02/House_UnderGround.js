function UnderGroundHouse(begin, W, D, H, floor_num, index_z, index_block) {
  ...
  this.num_winF_eachFloor = max(1, round(random((this.W-gap_win) / (this.W_win+gap_win) *0.5, (this.W-gap_win) / (this.W_win+gap_win))));
  this.num_winL_eachFloor = max(1, round(random((this.D-gap_win) / (this.W_win+gap_win) *0.5, (this.D-gap_win) / (this.W_win+gap_win))));
  this.num_winR_eachFloor = max(1, round(random((this.D-gap_win) / (this.W_win+gap_win) *0.5, (this.D-gap_win) / (this.W_win+gap_win))));
