...
function Bill_Youbetu(begin, index_z) {
  ...
  this.displayInfo = function() {
    ...
    LINES_getEllipse(this.node_triangle);
  };
}
//-----------------------------------------------------------------------------
//------------------------------⬆ Bill_Youbetu ⬆------------------------------
...
function Bill_Power(begin, index_z) {
  ...
  this.displayInfo = function() {
    ...
    LINES_getEllipse(this.node_electricity);
  };
}
...
function Bill_Bitcoin(begin, index_z) {
  ...
  this.displayInfo = function() {
    ...
    LINES_getLine(this.node_BTC[31], this.node_BTC[27]);

    for (let i=32; i<36; i++) {
      LINES_getLine(this.node_BTC[i], this.node_BTC[i+1]);
    }
    LINES_getLine(this.node_BTC[36], this.node_BTC[32]);
  };
}
...
function Bill_Metro(begin, index_z) {
  ...
  this.displayInfo = function() {
    ...
    LINES_getEllipse(this.node_rect);
  };
}
...
function Bill_File(begin, index_z) {
  ...
  this.displayInfo = function() {
    ...
    for (let i=0; i<this.num; i++) {
      ...
      LINES_getLine(this.node_files[i][10], this.node_files[i][5]);
    }
