  ...
  this.update = function() {
    ...
    if (this.house.length > 0) {
      for (let i=0; i<this.house.length; i++) {
        ...
        if (have_button_regenerate  &&  open_houseBeginY_followMountainY) {
          const i_node = this.node_front[0].length-1-(this.count_front_x-this.house_in_which_node[i]);
    ...
    for (let i=0; i<this.node_behind.length-1; i++) {
      for (let j=0; j<this.node_behind[i].length-1; j++) {
        ...
        if (open_darkCloud) {
          ...
          //c1 = lerpColor(lerpColor(c_sky, lerpColor(c_winFrame, c_sky, 0.15), map(this.node_behind[i][j].y, skyline.y-real(1000), skyline.y-real(1500), 0, 0.5)), c_near, constrain(map(this.node_behind[i][j].z, skyline.z, 0, 0, 1), 0, 1));
          //c2 = lerpColor(lerpColor(c_sky, lerpColor(c_winFrame, c_sky, 0.15), map(this.node_behind[i][j+1].y, skyline.y-real(1000), skyline.y-real(1500), 0, 0.5)), c_near, constrain(map(this.node_behind[i][j+1].z, skyline.z, 0, 0, 1), 0, 1));
          //c3 = lerpColor(lerpColor(c_sky, lerpColor(c_winFrame, c_sky, 0.15), map(this.node_behind[i+1][j+1].y, skyline.y-real(1000), skyline.y-real(1500), 0, 0.5)), c_near, constrain(map(this.node_behind[i+1][j+1].z, skyline.z, 0, 0, 1), 0, 1));
          //c4 = lerpColor(lerpColor(c_sky, lerpColor(c_winFrame, c_sky, 0.15), map(this.node_behind[i+1][j].y, skyline.y-real(1000), skyline.y-real(1500), 0, 0.5)), c_near, constrain(map(this.node_behind[i+1][j].z, skyline.z, 0, 0, 1), 0, 1));

          c1 = lerpColor(c1, lerpColor(c_winFrame, c_sky, 0.15), map(this.node_behind[i][j].y, skyline.y, Y_darkCloud, 0, 1));
          c2 = lerpColor(c2, lerpColor(c_winFrame, c_sky, 0.15), map(this.node_behind[i][j+1].y, skyline.y, Y_darkCloud, 0, 1));
          c3 = lerpColor(c3, lerpColor(c_winFrame, c_sky, 0.15), map(this.node_behind[i+1][j+1].y, skyline.y, Y_darkCloud, 0, 1));
          c4 = lerpColor(c4, lerpColor(c_winFrame, c_sky, 0.15), map(this.node_behind[i+1][j].y, skyline.y, Y_darkCloud, 0, 1));
        }
    ...
    for (let i=0; i<this.node_middle.length-1; i++) {
      for (let j=0; j<this.node_middle[i].length-1; j++) {
        ...
        if (open_darkCloud) {
          ...
          c1 = lerpColor(c1, lerpColor(c_winFrame, c_sky, 0.35), map(this.node_behind[i][j].y, skyline.y, Y_darkCloud, 0, 1));
          c2 = lerpColor(c2, lerpColor(c_winFrame, c_sky, 0.35), map(this.node_behind[i][j+1].y, skyline.y, Y_darkCloud, 0, 1));
          c3 = lerpColor(c3, lerpColor(c_winFrame, c_sky, 0.35), map(this.node_behind[i+1][j+1].y, skyline.y, Y_darkCloud, 0, 1));
          c4 = lerpColor(c4, lerpColor(c_winFrame, c_sky, 0.35), map(this.node_behind[i+1][j].y, skyline.y, Y_darkCloud, 0, 1));
          //c1 = changeBrightness(c1, -20);
          //c2 = changeBrightness(c2, -20);
          //c3 = changeBrightness(c3, -20);
          //c4 = changeBrightness(c4, -20);
        }
