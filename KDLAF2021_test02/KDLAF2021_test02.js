...
function preload() {
  ...
  sound_glitch = createAudio(['data/sound_glitch.mp3', 'data/sound_glitch.wav']);
}
...
function draw() {
  if (!open_homepage) {
    ...
    let s_y02_loading = constrain(map(y02_loading/v_loading, 0, y02_loading, y02_loading, (height-img_loading00.height)/2), y02_loading, (height-img_loading00.height)/2);
    let s_y01_loading = constrain(map(y01_loading/v_loading, 0, y01_loading, y01_loading, (height-img_loading00.height)/2), y01_loading, (height-img_loading00.height)/2);
    background(0);
