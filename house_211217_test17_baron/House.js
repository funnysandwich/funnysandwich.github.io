function House() {
  ...
  this.update = function() {
    ...
    if (!open_open) {
      ...
      let target = this.node[0].copy().add(0,real(5),0);
      this.eaves_FU = easing_p5(this.eaves_FU, target);
      this.eaves_FL = easing_p5(this.eaves_FL, target);
      this.eaves_FR = easing_p5(this.eaves_FR, target);
      this.eaves_BU = easing_p5(this.eaves_BU, target);
      this.eaves_BL = easing_p5(this.eaves_BL, target);
      this.eaves_BR = easing_p5(this.eaves_BR, target);
  ...
  this.display = function() {
    ...
    beginShape();
    vertex(this.wall_F[0][0].x, this.wall_F[0][0].y, this.wall_F[0][0].z);
    vertex(this.wall_R[0][0].x, this.wall_R[0][0].y, this.wall_R[0][0].z);
    vertex(this.wall_B[0][0].x, this.wall_B[0][0].y, this.wall_B[0][0].z);
    vertex(this.wall_L[0][0].x, this.wall_L[0][0].y, this.wall_L[0][0].z);
    endShape(CLOSE);
