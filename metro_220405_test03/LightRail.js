  ...
  this.display = function() {
    ...
    if (this.index_z == 0) {
      ...
      for (let i=0; i<this.node_rail.length; i++) {
        ...
        //endShape(CLOSE);
        TRIANGLES_getRect(this.node_rail[i], 
          createVector(this.node_rail[i].x+real(40), this.node_rail[i].y, this.node_rail[i].z), 
          createVector(this.node_rail[i].x+real(40), this.node_rail[i].y, this.node_rail[i].z+this.D*0.6), 
          createVector(this.node_rail[i].x, this.node_rail[i].y, this.node_rail[i].z+this.D*0.6));
      }
      ...
      //endShape(CLOSE);
      TRIANGLES_getRect(
        createVector(this.node_center.x-this.W/2.0, this.node_center.y-real(0.1), this.node_center.z-this.D*0.17), 
        createVector(this.node_center.x+this.W/2.0, this.node_center.y-real(0.1), this.node_center.z-this.D*0.17), 
        createVector(this.node_center.x+this.W/2.0, this.node_center.y-real(0.1), this.node_center.z-this.D*0.17+real(40)), 
        createVector(this.node_center.x-this.W/2.0, this.node_center.y-real(0.1), this.node_center.z-this.D*0.17+real(40)));
    }
