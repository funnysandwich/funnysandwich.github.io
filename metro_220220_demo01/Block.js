function Block(begin, W, D, index_z, index, isHouse, isRiver, isMountain, isSea, isRail, isNightMarket) {
  ...
  if (open_billMc  &&  !this.isRiver  &&  !this.isSea  &&  !this.isRail  &&  !this.isNightMarket) {
  ...
  this.isFair = false;
  if (open_fair  &&  !this.isRiver  &&  !this.isSea  &&  !this.isRail  &&  !this.isNightMarket) {
    if (this.index_z == 0) {
      this.isFair = false;
