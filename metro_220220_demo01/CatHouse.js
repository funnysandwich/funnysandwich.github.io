function CatHouse(begin, W, D, H, floor_num, index_z, index_block) {
  ...
  this.display = function() {
    ...
    for (let i=this.node_wall.length-1; i>=0; i--) {
    ...
    for (let i=0; i<this.node_winF.length; i++) {
      for (let j=0; j<this.node_winF[i].length; j++) {
        if (this.have_winF[i][j]) {
          ...
          beginShape();
          for (let k=0; k<this.node_winF[i][j].length; k++) {
            vertex(this.node_winF[i][j][k].x, this.node_winF[i][j][k].y, this.node_winF[i][j][k].z);
          }
          endShape(CLOSE);
        }
      }
    ...
    if (this.begin.x > -real(100)) {
      ...
      fill(c_win);
       ...
       beginShape();
       if (state_click == 1) {
       const t_c = constrain(map(this.node_wall[0][0].z, skyline.z, 0, 1, 0), 0, 1);
       const c = lerpColor(c_near, c_far, t_c);
       t = constrain(map(this.time_winL[i][j], 0, 10, 0, 1), 0, 1);
       fill(lerpColor(c_win, c, t));
       }
       ...
       if (state_click == 1) {
       const t_c = constrain(map(this.node_wall[0][3].z, skyline.z, 0, 1, 0), 0, 1);
       const c = lerpColor(c_near, c_far, t_c);
       t = constrain(map(this.time_winL[i][j], 0, 10, 0, 1), 0, 1);
       fill(lerpColor(c_win, c, t));
       }
    ...
    if (this.begin.x+this.W < real(100)) {
      ...
      fill(c_win);
       ...
       beginShape();
       if (state_click == 1) {
       const t_c = constrain(map(this.node_wall[0][1].z, skyline.z, 0, 1, 0), 0, 1);
       const c = lerpColor(c_near, c_far, t_c);
       ...
       if (state_click == 1) {
       const t_c = constrain(map(this.node_wall[0][2].z, skyline.z, 0, 1, 0), 0, 1);
       const c = lerpColor(c_near, c_far, t_c);
       t = constrain(map(this.time_winR[i][j], 0, 10, 0, 1), 0, 1);
       fill(lerpColor(c_win, c, t));
       }
    ...
    if (this.node_earL[0][1].x > -real(100)) {
      beginShape();
      t = constrain(map(this.node_earL[0][0].z, skyline.z, 0, 1, 0), 0, 1);
      fill(lerpColor(c_near, c_far, t));
      vertex(this.node_earL[2][0].x, this.node_earL[2][0].y, this.node_earL[2][0].z);
      vertex(this.node_earL[0][0].x, this.node_earL[0][0].y, this.node_earL[0][0].z);
      t = constrain(map(this.node_earL[0][1].z, skyline.z, 0, 1, 0), 0, 1);
      fill(lerpColor(c_near, c_far, t));
      vertex(this.node_earL[0][1].x, this.node_earL[0][1].y, this.node_earL[0][1].z);
      vertex(this.node_earL[2][1].x, this.node_earL[2][1].y, this.node_earL[2][1].z);
    ...
    beginShape();
    t = constrain(map(this.node_earL[2][0].z, skyline.z, 0, 1, 0), 0, 1);
    fill(lerpColor(c_near, c_far, t));
    vertex(this.node_earL[2][0].x, this.node_earL[2][0].y, this.node_earL[2][0].z);
    vertex(this.node_earL[1][0].x, this.node_earL[1][0].y, this.node_earL[1][0].z);
    t = constrain(map(this.node_earL[2][1].z, skyline.z, 0, 1, 0), 0, 1);
    fill(lerpColor(c_near, c_far, t));
    vertex(this.node_earL[1][1].x, this.node_earL[1][1].y, this.node_earL[1][1].z);
    vertex(this.node_earL[2][1].x, this.node_earL[2][1].y, this.node_earL[2][1].z);
    endShape(CLOSE);
    ...
    if (this.node_earR[0][1].x < real(100)) {
      beginShape();
      t = constrain(map(this.node_earR[0][0].z, skyline.z, 0, 1, 0), 0, 1);
      fill(lerpColor(c_near, c_far, t));
      vertex(this.node_earR[2][0].x, this.node_earR[2][0].y, this.node_earR[2][0].z);
      vertex(this.node_earR[0][0].x, this.node_earR[0][0].y, this.node_earR[0][0].z);
      t = constrain(map(this.node_earR[0][1].z, skyline.z, 0, 1, 0), 0, 1);
      fill(lerpColor(c_near, c_far, t));
      vertex(this.node_earR[0][1].x, this.node_earR[0][1].y, this.node_earR[0][1].z);
      vertex(this.node_earR[2][1].x, this.node_earR[2][1].y, this.node_earR[2][1].z);
    ...
    beginShape();
    t = constrain(map(this.node_earR[2][0].z, skyline.z, 0, 1, 0), 0, 1);
    fill(lerpColor(c_near, c_far, t));
    vertex(this.node_earR[2][0].x, this.node_earR[2][0].y, this.node_earR[2][0].z);
    vertex(this.node_earR[1][0].x, this.node_earR[1][0].y, this.node_earR[1][0].z);
    t = constrain(map(this.node_earR[2][1].z, skyline.z, 0, 1, 0), 0, 1);
    fill(lerpColor(c_near, c_far, t));
    vertex(this.node_earR[1][1].x, this.node_earR[1][1].y, this.node_earR[1][1].z);
    vertex(this.node_earR[2][1].x, this.node_earR[2][1].y, this.node_earR[2][1].z);
    endShape(CLOSE);
