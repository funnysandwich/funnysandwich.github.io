function Rain(rangeX_L, rangeX_R, rangeZ_B, rangeZ_F, weight) {
  ...
  this.node[0] = createVector(random(rangeX_L, rangeX_R), -real(1000), random(rangeZ_F, rangeZ_B));
  ...
  this.display = function() {
    ...
    LINES_getLine_weight(this.node[0], this.node[1], w);
  };
