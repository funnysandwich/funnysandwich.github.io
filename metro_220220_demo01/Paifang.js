  ...
  this.display = function() {
    ...
    for (let i=0; i<this.node_pillar.length; i++) {
      if (this.node_pillar[i][1][3].x > -real(100)) {
        ...
        TRIANGLES_getRect_fill2(this.node_pillar[i][1][0], this.node_pillar[i][1][3], this.node_pillar[i][0][3], this.node_pillar[i][0][0], c1, c2, c2, c1);
      }
    }
    ...
    for (let i=0; i<this.node_pillar.length; i++) {
      if (this.node_pillar[i][1][2].x < real(100)) {
        ...
        c2 = lerpColor(c_near, c_far, t);
        TRIANGLES_getRect_fill2(this.node_pillar[i][1][2], this.node_pillar[i][1][1], this.node_pillar[i][0][1], this.node_pillar[i][0][2], c1, c2, c2, c1);
      }
    }
    ...
    if (this.node_wall[1][3].x > -real(100)) {
      ...
      t = constrain(map(this.node_wall[0][3].z, skyline.z, 0, 1, 0), 0, 1);
      c2 = lerpColor(c_near, c_far, t);
      TRIANGLES_getRect_fill2(this.node_wall[1][0], this.node_wall[1][3], this.node_wall[0][3], this.node_wall[0][0], c1, c2, c2, c1);
    }
    //--- wall R ---
    if (this.node_wall[1][2].x < real(100)) {
      ...
      c2 = lerpColor(c_near, c_far, t);
      TRIANGLES_getRect_fill2(this.node_wall[1][2], this.node_wall[1][1], this.node_wall[0][1], this.node_wall[0][2], c1, c2, c2, c1);
    }
    ...
    for (let i=0; i<this.node_eaver.length-1; i++) {
      if (this.state == 0) {
        ...
        c2 = lerpColor(c_near, c_far, t);
        TRIANGLES_getRect_fill2(this.node_eaver[i+1][3], this.node_eaver[i+1][2], this.node_eaver[i][2], this.node_eaver[i][3], c1, c1, c2, c2);
      } else if (this.state == 1  ||  this.state == 2) {
        t = constrain(map(this.node_eaver[i+1][3].z, skyline.z, 0, 1, 0), 0, 1);
        c1 = lerpColor(c_near, c_far, t);
        t = constrain(map(this.node_eaver[i][3].z, skyline.z, 0, 1, 0), 0, 1);
        c2 = lerpColor(c_near, c_far, t);
        TRIANGLES_getRect_fill2(this.node_eaver[i+1][3], this.node_eaver_cut[i+1][0], this.node_eaver_cut[i][0], this.node_eaver[i][3], c1, c1, c2, c2);
        TRIANGLES_getRect_fill2(this.node_eaver_cut[i+1][1], this.node_eaver[i+1][2], this.node_eaver[i][2], this.node_eaver_cut[i][1], c1, c1, c2, c2);
        t = constrain(map(this.node_wall[0][0].z, skyline.z, 0, 1, 0), 0, 1);
        c1 = lerpColor(c_near, c_far, t);
    ...
    for (let i=0; i<this.node_eaver.length-1; i++) {
      ...
      t = constrain(map(this.node_eaver[i][3].z, skyline.z, 0, 1, 0), 0, 1);
      c2 = lerpColor(c_near, c_far, t);
      TRIANGLES_getRect_fill2(this.node_eaver[i+1][0], this.node_eaver[i+1][3], this.node_eaver[i][3], this.node_eaver[i][0], c1, c2, c2, c1);
    }
    //--- eaver R ---
    for (let i=0; i<this.node_eaver.length-1; i++) {
      ...
      c2 = lerpColor(c_near, c_far, t);
      TRIANGLES_getRect_fill2(this.node_eaver[i+1][2], this.node_eaver[i+1][1], this.node_eaver[i][1], this.node_eaver[i][2], c1, c2, c2, c1);
    }
    //--- eaver D ---
    if (this.state == 0) {
    ...
    if (this.state == 1  ||  this.state == 2) {
      ...
      if (this.node_wall2[1][3].x > -real(100)) {
        ...
        c2 = lerpColor(c_near, c_far, t);
        TRIANGLES_getRect_fill2(this.node_wall2[1][0], this.node_wall2[1][3], this.node_wall2[0][3], this.node_wall2[0][0], c1, c2, c2, c1);
      }
      //--- wall2 R ---
      if (this.node_wall2[1][2].x < real(100)) {
        ...
        c2 = lerpColor(c_near, c_far, t);
        TRIANGLES_getRect_fill2(this.node_wall2[1][2], this.node_wall2[1][1], this.node_wall2[0][1], this.node_wall2[0][2], c1, c2, c2, c1);
      }
      ...
      for (let i=0; i<this.node_eaver2.length-1; i++) {
        ...
        c2 = lerpColor(c_near, c_far, t);
        TRIANGLES_getRect_fill2(this.node_eaver2[i+1][3], this.node_eaver2[i+1][2], this.node_eaver2[i][2], this.node_eaver2[i][3], c1, c1, c2, c2);
      }
      //--- eaver2 L ---
      for (let i=0; i<this.node_eaver2.length-1; i++) {
        ...
        t = constrain(map(this.node_eaver2[i][3].z, skyline.z, 0, 1, 0), 0, 1);
        c2 = lerpColor(c_near, c_far, t);
        TRIANGLES_getRect_fill2(this.node_eaver2[i+1][0], this.node_eaver2[i+1][3], this.node_eaver2[i][3], this.node_eaver2[i][0], c1, c2, c2, c1);
      }
      //--- eaver2 R ---
      for (let i=0; i<this.node_eaver2.length-1; i++) {
        ...
        c2 = lerpColor(c_near, c_far, t);
        TRIANGLES_getRect_fill2(this.node_eaver2[i+1][2], this.node_eaver2[i+1][1], this.node_eaver2[i][1], this.node_eaver2[i][2], c1, c2, c2, c1);
      }
      //--- eaver D ---
    ...
    if (this.state == 2) {
      ...
      for (let i=0; i<this.node_pillar2.length; i++) {
        if (this.node_pillar2[i][1][3].x > -real(100)) {
          ...
          c2 = lerpColor(c_near, c_far, t);
          TRIANGLES_getRect_fill2(this.node_pillar2[i][1][0], this.node_pillar2[i][1][3], this.node_pillar2[i][0][3], this.node_pillar2[i][0][0], c1, c2, c2, c1);
        }
      }
      ...
      for (let i=0; i<this.node_pillar2.length; i++) {
        if (this.node_pillar2[i][1][2].x < real(100)) {
          ...
          c2 = lerpColor(c_near, c_far, t);
          TRIANGLES_getRect_fill2(this.node_pillar2[i][1][2], this.node_pillar2[i][1][1], this.node_pillar2[i][0][1], this.node_pillar2[i][0][2], c1, c2, c2, c1);
        }
      }
