function House(begin, W, D, H, floor_num, index_z, index_block) {
  ...
  if (open_billboard  &&  random(1)<rate_billboard  &&  this.floor_num>1) {
    if (index_z == 1) {
      ...
      this.have_billboard = false;
    } else if (random(1)<map(index_z, 1, 6, rate_billboard*0.7, 0.01)) {
      this.have_billboard = true;
    }
  }

  this.have_billboardRoof = false;
  if (open_billboardRoof  &&  random(1)<rate_billboardRoof  &&  this.floor_num>1  &&  !this.have_roof) {
    if (index_z == 1) {
  ...
  if (this.have_billboard) {
    this.num_billboard = floor(random(1, this.floor_num-1));
    let count_floor = [];
  ...
  if (this.have_billboardRoof) {
    this.state_billboardRoof = floor(random(0, 2));
  ...
  this.change = function(begin1, W, D, H, floor_num, index_block) {
    ...
    if (open_billboard  &&  random(1)<rate_billboard  &&  this.floor_num>1) {
      if (index_z == 1) {
        ...
        this.have_billboard = false;
      } else if (random(1)<map(index_z, 1, 6, rate_billboard*0.7, 0.1)) {
        this.have_billboard = true;
      }
    }
    ...
    if (open_billboardRoof  &&  random(1)<rate_billboardRoof  &&  this.floor_num>1  &&  !this.have_roof) {
      if (index_z == 1) {
        ...
        this.have_billboardRoof = false;
      } else if (random(1)<map(index_z, 1, 6, rate_billboardRoof, 0.01)) {
        this.have_billboardRoof = true;
      }
    }
  ...
  this.display = function() {
      ...
      for (let j=0; j<this.node_winF[i].length; j++) {
        if (this.have_winF[i][j]) {
          if (state_click == 1) {
            ...
            fill(lerpColor(c_win, lerpColor(c_near, c_far, constrain(map(this.node_wall[0][3].z, skyline.z, 0, 1, 0), 0, 1)), t));
          }
        ...
        for (let j=0; j<this.node_winL[i].length; j++) {
          if (this.have_winL[i][j]) {
            if (state_click == 1) {
              ...
              fill(lerpColor(c_win, lerpColor(c_near, c_far, constrain(map(this.node_wall[0][0].z, skyline.z, 0, 1, 0), 0, 1)), t));
            }
        ...
        for (let j=0; j<this.node_winR[i].length; j++) {
          if (this.have_winR[i][j]) {
            if (state_click == 1) {
              ...
              fill(lerpColor(c_win, lerpColor(c_near, c_far, constrain(map(this.node_wall[0][2].z, skyline.z, 0, 1, 0), 0, 1)), t));
            }
            vertex(this.node_winR[i][j][0].x, this.node_winR[i][j][0].y, this.node_winR[i][j][0].z);
            if (state_click == 1) {
              t = constrain(map(this.time_winR[i][j], 0, 10, 0, 1), 0, 1);
              fill(lerpColor(c_win, lerpColor(c_near, c_far, constrain(map(this.node_wall[0][1].z, skyline.z, 0, 1, 0), 0, 1)), t));
            }
    ...
    //beginShape();
    //this.t_c = constrain(map(this.node[0][0].z, skyline.z, 0, 1, 0), 0, 1);
    //this.c = lerpColor(color(0), color(255), this.t_c);
    //fill(this.c);
    //vertex(this.node[1][0].x, this.node[1][0].y, this.node[1][0].z);
    //vertex(this.node[1][1].x, this.node[1][1].y, this.node[1][1].z);
    //this.t_c = constrain(map(this.node[0][2].z, skyline.z, 0, 1, 0), 0, 1);
    //this.c = lerpColor(color(0), color(255), this.t_c);
    //fill(this.c);
    //vertex(this.node[1][2].x, this.node[1][2].y, this.node[1][2].z);
    //vertex(this.node[1][3].x, this.node[1][3].y, this.node[1][3].z);
    //endShape(CLOSE);
    //------------- ⬇U⬇ -------------
    //if (this.floor_num<4 && this.H_ori<real(110)) {
    beginShape();
    t = constrain(map(this.node_wall[0][0].z, skyline.z, 0, 1, 0), 0, 1);
    fill(lerpColor(c_near, c_far, t));
    vertex(this.node_wall[this.node_wall.length-1][0].x, this.node_wall[this.node_wall.length-1][0].y, this.node_wall[this.node_wall.length-1][0].z);
    vertex(this.node_wall[this.node_wall.length-1][1].x, this.node_wall[this.node_wall.length-1][1].y, this.node_wall[this.node_wall.length-1][1].z);
    t = constrain(map(this.node_wall[0][2].z, skyline.z, 0, 1, 0), 0, 1);
    fill(lerpColor(c_near, c_far, t));
    vertex(this.node_wall[this.node_wall.length-1][2].x, this.node_wall[this.node_wall.length-1][2].y, this.node_wall[this.node_wall.length-1][2].z);
    vertex(this.node_wall[this.node_wall.length-1][3].x, this.node_wall[this.node_wall.length-1][3].y, this.node_wall[this.node_wall.length-1][3].z);
    endShape(CLOSE);
    //}
    //------------- ⬆U⬆ -------------
    ...
    if (this.have_roof) {
      if (this.state_roofWall) {
        ...
        vertex(this.node_wall_overbuild[0][2].x, this.node_wall_overbuild[0][2].y, this.node_wall_overbuild[0][2].z);
        vertex(this.node_wall_overbuild[0][3].x, this.node_wall_overbuild[0][3].y, this.node_wall_overbuild[0][3].z);
        endShape(CLOSE);
        //--- L_roof_wall ---
        if (this.node_wall_overbuild[0][3].x > -real(10)) {
          beginShape();
          t = constrain(map(this.node_wall_overbuild[0][0].z, skyline.z, 0, 1, 0), 0, 1);
          fill(lerpColor(c_near, c_far, t));
          vertex(this.node_wall_overbuild[0][0].x, this.node_wall_overbuild[0][0].y, this.node_wall_overbuild[0][0].z);
        ...
        //--- R_roof_wall ---
        if (this.node_wall_overbuild[0][2].x < real(10)) {
          beginShape();
          t = constrain(map(this.node_wall_overbuild[0][2].z, skyline.z, 0, 1, 0), 0, 1);
          fill(lerpColor(c_near, c_far, t));
          vertex(this.node_wall_overbuild[0][2].x, this.node_wall_overbuild[0][2].y, this.node_wall_overbuild[0][2].z);
          vertex(this.node_wall_overbuild[1][2].x, this.node_wall_overbuild[1][2].y, this.node_wall_overbuild[1][2].z);
          t = constrain(map(this.node_wall_overbuild[0][1].z, skyline.z, 0, 1, 0), 0, 1);
          fill(lerpColor(c_near, c_far, t));
          vertex(this.node_wall_overbuild[1][1].x, this.node_wall_overbuild[1][1].y, this.node_wall_overbuild[1][1].z);
          vertex(this.node_wall_overbuild[0][1].x, this.node_wall_overbuild[0][1].y, this.node_wall_overbuild[0][1].z);
          endShape(CLOSE);
        }
      } else {
        noFill();
      ...
      if (this.X_rate_roofU > 0 || this.state_roofWall) {
        noStroke();
        beginShape();
        t = constrain(map(this.node_wall_overbuild[1][0].z, skyline.z, 0, 1, 0), 0, 1);
        fill(lerpColor(c_near, c_far, t));
        vertex(this.node_wall_overbuild[1][0].x, this.node_wall_overbuild[1][0].y, this.node_wall_overbuild[1][0].z);
        vertex(this.node_roofUB.x, this.node_roofUB.y, this.node_roofUB.z);
        t = constrain(map(this.node_wall_overbuild[1][3].z, skyline.z, 0, 1, 0), 0, 1);
        fill(lerpColor(c_near, c_far, t));
        vertex(this.node_roofUF.x, this.node_roofUF.y, this.node_roofUF.z);
        vertex(this.node_wall_overbuild[1][3].x, this.node_wall_overbuild[1][3].y, this.node_wall_overbuild[1][3].z);
        endShape(CLOSE);
      ...
      if (this.X_rate_roofU < 1 || this.state_roofWall) {
        noStroke();
        beginShape();
        t = constrain(map(this.node_wall_overbuild[1][2].z, skyline.z, 0, 1, 0), 0, 1);
        fill(lerpColor(c_near, c_far, t));
        vertex(this.node_wall_overbuild[1][2].x, this.node_wall_overbuild[1][2].y, this.node_wall_overbuild[1][2].z);
        vertex(this.node_roofUF.x, this.node_roofUF.y, this.node_roofUF.z);
        t = constrain(map(this.node_wall_overbuild[1][1].z, skyline.z, 0, 1, 0), 0, 1);
        fill(lerpColor(c_near, c_far, t));
        vertex(this.node_roofUB.x, this.node_roofUB.y, this.node_roofUB.z);
        vertex(this.node_wall_overbuild[1][1].x, this.node_wall_overbuild[1][1].y, this.node_wall_overbuild[1][1].z);
        endShape(CLOSE);
    ...
    if (this.have_handrail) {
      noFill();
      strokeWeight(real(4));
      t = constrain(map(this.node[this.node.length-1].z, skyline.z, 0, 1, 0), 0, 1);
      stroke(lerpColor(c_near, c_far, t));
      beginShape(LINES);
      for (let i=0; i<this.node_handrail.length; i++) {
        for (let j=0; j<this.node_handrail[i].length; j++) {
        ...
        vertex(this.node_handrail[i][1].x, this.node_handrail[i][1].y, this.node_handrail[i][1].z);
        vertex(this.node_handrail[(i+1)%this.node_handrail.length][1].x, this.node_handrail[(i+1)%this.node_handrail.length][1].y, this.node_handrail[(i+1)%this.node_handrail.length][1].z);
      }
      endShape();
    }
    ...
    if (this.have_billboardRoof) {
      ...
      beginShape(LINES);
      for (let i=0; i<this.node_billboardRoof.length; i++) {
        let z0 = this.node_billboardRoof[i][0].z;
        let z2 = this.node_billboardRoof[i][2].z;
        if (i != 0  &&  i !=this.node_billboardRoof.length-1) {
          z0 -= real(2);
          z2 -= real(2);
        }
        vertex(this.node_billboardRoof[i][0].x, this.node_billboardRoof[i][0].y, z0);
        vertex(this.node_billboardRoof[i][2].x, this.node_billboardRoof[i][2].y, z2);
