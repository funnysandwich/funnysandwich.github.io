function OrientHouse(begin, W, D, H, floor_num, index_z, index_block) {
  ...
  if (this.have_billboard) {
    ...
    for (let i=0; i<this.num_billboard; i++) {
      ...
      this.W_billboard[i] = max(random(this.W[this.whichFloor_billboard[i]]*0.1, this.W[this.whichFloor_billboard[i]]*0.95), real(100));
      this.H_billboard[i] = random(this.H_ori*0.35, this.H_ori*0.75);
  ...
  if (this.have_billboardRoof) {
    ...
    this.W_billboardRoof = max(this.W[this.W.length-1] * random(0.15, 1), real(25));
  ...
  this.change = function(begin1, W, D, H, floor_num, index_block) {
    ...
    if (this.have_billboard) {
      ...
      for (let i=0; i<this.num_billboard; i++) {
        ...
        this.W_billboard[i] = max(random(this.W[this.whichFloor_billboard[i]]*0.1, this.W[this.whichFloor_billboard[i]]*0.95), real(100));
        this.H_billboard[i] = random(this.H_ori*0.3, this.H_ori*0.75);
        this.X_billboard[i] = random(0, this.W[this.whichFloor_billboard[i]]-this.W_billboard[i]);
        this.Z_billboard[i] = real(random(2.5, 10));
        this.which_BILL[i] = floor(random(0, BILL.length));
      }
